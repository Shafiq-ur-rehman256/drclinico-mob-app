...
import chatbox from "../pages/Doctor/doctorChatBox";
import doctorInbox from "../pages/Doctor/doctorInbox";
import AssignPrescription from "../pages/Doctor/AssignPrescription";
...
export default function PatientNavigation() {
  return (
    ...
    >
      ...
      <Stack.Screen name="assign_prescription" component={AssignPrescription} />
    </Stack.Navigator>
  );
}
