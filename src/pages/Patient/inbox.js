...
import { deSelectChat, GetAllConvoForPatient, selectChat } from "../../store/patientReducer";

export default Inbox = ({ navigation,route }) => {

  const dispatch = useDispatch();
  const patientState = useSelector(state => state.patientState.chatScreen);
  ...
  useEffect(()=>{
    dispatch(GetAllConvoForPatient());
  ...
  const navigateToChat = (chat) =>{
    ...
    navigation.navigate('PatientStack', {
      screen: 'chat_box',
      params: { convo: chat, accessControl: "patient" },
    })
    ...
    <View style={styles.chatContainer}>
      <View style={styles.nameAndMessage}>
        ...
        <View style={styles.infoBody}>
          <Text style={styles.senderName}>{chat.docter.full_name}</Text>
          {chat.docter.specialization !== null && (
            <Text style={styles.specialization}>
              {chat.docter.specialization}
            </Text>
          )}
          <Text
            style={
