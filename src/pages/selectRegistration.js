...
export const SelectRegistration = ({ navigation }) => {
  ...
  routeTo = () => {
    ...
    if (!doctor)
      navigation.navigate("RegisterStack", { screen: "doctor_signup" });
    if (!emergency)
    ...
    <View style={styles.container}>
      ...
      <View style={styles.registrationSection}>
        <Pressable
          ...
          onTouchStart={() => selectRegistration(pateint, selectPatient)}
        >
        ...
        <Pressable
          style={styles.section}
          onTouchStart={() => selectRegistration(doctor, selectDoctor)}
        >
          <View style={styles.iconContainer}>
            <Image
              style={styles.icon}
          ...
          <View style={styles.sectionText}>
            <Text
              style={
                doctor == true ? styles.sectionText1 : styles.sectionText1Active
              }
            >
              I’m a doctor
            </Text>
        ...
        <Pressable
          style={styles.section}
          onTouchStart={() => selectRegistration(emergency, selectEmergency)}
        >
          <View style={styles.iconContainer}>
            <Image
              style={styles.icon}
      ...
      <View style={styles.bottomBtn}>
        <PrimaryButton
          prop={{ text: "Continue", onPress: routeTo }}
        ></PrimaryButton>
      </View>
